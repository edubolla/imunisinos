...
export default function ImuniFullScreenChat() {
  ...
  return (
    <div className="flex h-screen flex-col bg-white">
      <header className="flex items-center justify-between gap-4 bg-primary px-4 py-3 text-white sm:px-6 lg:px-10">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto bg-primary-light/50 px-4 py-6 sm:px-6 lg:px-10">
      ...
      <div className="border-t border-black/5 bg-white px-4 py-4 sm:px-6 lg:px-10">
